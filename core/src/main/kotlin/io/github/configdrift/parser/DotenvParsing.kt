...
object DotenvParsing {
    ...
    /**
     * Shared with Compose list-form `KEY=VALUE` entries (`- DB_HOST="localhost"`), the same
     * env-line value syntax dotenv uses — see [io.github.configdrift.parser.DockerComposeConfigParser]
     * / text Compose parsing for why a separate unquote caused drift false positives.
     */
